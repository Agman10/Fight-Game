...
public class TempPlayerAnimations : MonoBehaviour
{
    ...
    public void SetDefaultPose()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            ...
            this.leftArmJoint.localScale = new Vector3(1f, 1f, 1f);
        ...
        if (this.belt != null)
            this.belt.localEulerAngles = new Vector3(0f, 0f, 0f);
    ...
    [ContextMenu("PrintPoseValues")]
    public void PrintPoseValues()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            ...
            Debug.Log(
                "this.rightArm.localEulerAngles = new Vector3(" + this.rightArm.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.rightArm.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.rightArm.localEulerAngles.z.ToString().Replace(",", ".") + "f);" + "\n" +
                "this.leftArm.localEulerAngles = new Vector3(" + this.leftArm.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.leftArm.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.leftArm.localEulerAngles.z.ToString().Replace(",", ".") + "f);" + "\n" +
                "this.rightArmJoint.localEulerAngles = new Vector3(" + this.rightArmJoint.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.rightArmJoint.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.rightArmJoint.localEulerAngles.z.ToString().Replace(",", ".") + "f);" + "\n" +
                "this.leftArmJoint.localEulerAngles = new Vector3(" + this.leftArmJoint.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.leftArmJoint.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.leftArmJoint.localEulerAngles.z.ToString().Replace(",", ".") + "f);" + "\n" +
                "\n" +
                "this.rightLeg.localEulerAngles = new Vector3(" + this.rightLeg.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.rightLeg.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.rightLeg.localEulerAngles.z.ToString().Replace(",", ".") + "f);" + "\n" +
                "this.leftLeg.localEulerAngles = new Vector3(" + this.leftLeg.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.leftLeg.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.leftLeg.localEulerAngles.z.ToString().Replace(",", ".") + "f);" + "\n" +
                "this.rightLegJoint.localEulerAngles = new Vector3(" + this.rightLegJoint.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.rightLegJoint.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.rightLegJoint.localEulerAngles.z.ToString().Replace(",", ".") + "f);" + "\n" +
                "this.leftLegJoint.localEulerAngles = new Vector3(" + this.leftLegJoint.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.leftLegJoint.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.leftLegJoint.localEulerAngles.z.ToString().Replace(",", ".") + "f);"
                );


            //Debug.Log(this.rightArmJoint.localEulerAngles.x - 360);
            //Debug.Log(this.rightArmJoint.localEulerAngles);
            //string rightarm = this.rightArm.localEulerAngles.y.ToString().Replace(",", ".");
            //Debug.Log(rightarm + "f");

            //Debug.Log(this.rightArm.localEulerAngles.y);
            //this.rightArm.localEulerAngles = new Vector3(0.0, 20.4, 65.8);
            //Debug.Log(this.rightArm.localEulerAngles.y + "f");
            //Debug.Log("this.rightArm.localEulerAngles = new Vector3(" + this.rightArm.localEulerAngles.x + "f, " + this.rightArm.localEulerAngles.y + "f, " + this.rightArm.localEulerAngles.z + "f);");
            //Debug.Log("this.rightArm.localEulerAngles = new Vector3" + this.rightArm.localEulerAngles + ";");


            //Debug.Log("this.rightArm.localEulerAngles = new Vector3(" + this.rightArm.localEulerAngles.x + "f, " + this.rightArm.localEulerAngles.y + "f, " + this.rightArm.localEulerAngles.z + "f);");
            //Debug.Log("this.rightArm.localEulerAngles = new Vector3(" + this.rightArm.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.rightArm.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.rightArm.localEulerAngles.z.ToString().Replace(",", ".") + "f);");
        }
        ...
        if (this.upperBody != null && this.lowerBody != null)
        {
            ...
            Debug.Log(
                "this.upperBody.localEulerAngles = new Vector3(" + this.upperBody.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.upperBody.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.upperBody.localEulerAngles.z.ToString().Replace(",", ".") + "f);" + "\n" +
                "this.lowerBody.localEulerAngles = new Vector3(" + this.lowerBody.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.lowerBody.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.lowerBody.localEulerAngles.z.ToString().Replace(",", ".") + "f);"
                );
        }
        ...
        if (this.eyes != null)
        {
            ...
            /*float eyeRotY = this.eyes.localEulerAngles.y;
            if (eyeRotY < 0)
                eyeRotY = eyeRotY - 360f;
            Debug.Log(eyeRotY);*/
            Debug.Log(
                "this.eyes.localEulerAngles = new Vector3(" + this.eyes.localEulerAngles.x.ToString().Replace(",", ".") + "f, " + this.eyes.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.eyes.localEulerAngles.z.ToString().Replace(",", ".") + "f);"
                );
        ...
        if (this.body != null)
        {
            ...
            Debug.Log(
                "this.body.localPosition = new Vector3(" + this.body.localPosition.x.ToString().Replace(",", ".") + "f, this.defaultYPos - " + (this.defaultYPos - this.body.localPosition.y).ToString().Replace(",", ".") + "f, this.transform.forward.z * " + this.body.localPosition.z.ToString().Replace(",", ".") + "f);" + "\n" +
                "this.body.localEulerAngles = new Vector3(this.transform.forward.z * " + this.body.localEulerAngles.x.ToString().Replace(",", ".") + "f, this.transform.forward.z * " + this.body.localEulerAngles.y.ToString().Replace(",", ".") + "f, " + this.body.localEulerAngles.z.ToString().Replace(",", ".") + "f);"
                );
    ...
    public void JokeSuperFireBall(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(73f, 20f, -25f);
                this.leftArm.localEulerAngles = new Vector3(-33f, 0f, 0f);
                this.rightArmJoint.localEulerAngles = new Vector3(52f, 0f, 0f);
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(73f, 20f, -3f);
                this.leftArm.localEulerAngles = new Vector3(-33f, 0f, 25f);
                this.rightArmJoint.localEulerAngles = new Vector3(34f, 0f, 67f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 78f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 0f, -20f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 0f, -2f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, 18f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -18f);
            }
            else
            {
                this.rightArm.localEulerAngles = new Vector3(0f, 20f, 80f);
                this.leftArm.localEulerAngles = new Vector3(-33f, 0f, -32f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 10f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 50f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 0f, -27f);
        ...
        if (this.upperBody != null && this.lowerBody != null)
        {
            if (stageId == 0)
            {
                this.upperBody.localEulerAngles = new Vector3(0f, 11f, 0f);
                this.lowerBody.localEulerAngles = new Vector3(0f, 0f, 0f);
            }
            else if (stageId == 1)
            {
        ...
        if (this.body != null)
        {
            if (stageId == 0)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.01f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 42f, 0f);
            }
            else if (stageId == 1)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.03f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 20f, 0f);
            }
            else
            {
    ...
    public void JokeSuperFireBallAir(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
        ...
        if (this.upperBody != null && this.lowerBody != null)
        {
            if (stageId == 0)
            {
                this.upperBody.localEulerAngles = new Vector3(0f, 53f, 0f);
            }
            else if (stageId == 1)
            {
    ...
    public void RoadRollerPunchMid()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(90f, 0f, -35f);
    ...
    public void RoadRollerRiseUp()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(25f, 0f, -2f);
            this.leftArm.localEulerAngles = new Vector3(-25f, 0f, -2f);
            this.rightArmJoint.localEulerAngles = new Vector3(-10f, 0f, 0f);
            this.leftArmJoint.localEulerAngles = new Vector3(10f, 0f, 0f);
        ...
        {
            this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 2f, 2f);
        }
    ...
    public void RoadRollerEndLand()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            ...
            this.rightLeg.localEulerAngles = new Vector3(0f, 0f, 25f);
            this.leftLeg.localEulerAngles = new Vector3(0f, 0f, 65f);
            this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -113f);
            this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -119f);
        }
        ...
        if (this.body != null)
        {
            this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.51f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, 0f);
        }
    ...
    public void HoodGuyGrab(int eyeId = 3)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
    ...
    public void HoodGuyGrabMid(int eyeId = 3)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
    ...
    public void HoodGuyGrabStart(int eyeId = 3)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
    ...
    public void HoldingOneFlameHurt()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(2f, -14f, 61f);
            this.leftArm.localEulerAngles = new Vector3(7f, -6f, 43f);
            this.rightArmJoint.localEulerAngles = new Vector3(0f, -43f, 81f);
            this.leftArmJoint.localEulerAngles = new Vector3(85f, 0f, 35f);
        ...
        if (this.eyes != null)
            this.eyes.localEulerAngles = new Vector3(0f, 2f, 0f);
    ...
    public void MasterFlameGrab(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            ...
            else if (stageId == 1)
            {
                this.rightArm.localEulerAngles = new Vector3(0f, 12.5f, 120f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
                //this.leftArm.localEulerAngles = new Vector3(0f, 50f, -70f);
                this.leftArm.localEulerAngles = new Vector3(0f, 50f, -60f);
                this.leftArmJoint.localEulerAngles = new Vector3(-120f, 0f, 0f);
            }
            else if (stageId == 2)
            {
                this.rightArm.localEulerAngles = new Vector3(25f, 0f, 0f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 56f);
                this.leftArm.localEulerAngles = new Vector3(0f, 115f, -100f);
                this.leftArmJoint.localEulerAngles = new Vector3(-90f, -23f, 0f);

                /*this.leftArm.localEulerAngles = new Vector3(0f, 115f, -70f);
                this.leftArmJoint.localEulerAngles = new Vector3(-99f, -23.15f, 0f);*/
            ...
            else if (stageId == 3)
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 0f, -30f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 60f);
                this.leftArm.localEulerAngles = new Vector3(0f, -12f, 120f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
            }
            else if (stageId == 4)
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 0f, -10f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 30f);
                this.leftArm.localEulerAngles = new Vector3(-10f, 10f, 30f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
            }
            else
            {
        ...
        if (this.body != null)
        {
            ...
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * -30f, 0f);
            }
    ...
    public void MasterFlameGrabbed()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(20f, 0f, 5f);
    ...
    public void MasterFlameGrabStartPose()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(14f, 0f, 0f);
            this.leftArm.localEulerAngles = new Vector3(-116.5f, 12.5f, 42f);
            this.rightArmJoint.localEulerAngles = new Vector3(32f, -5f, 0f);
            this.leftArmJoint.localEulerAngles = new Vector3(0f, 78f, -94f);

            /*this.rightArm.localEulerAngles = new Vector3(162f, 0f, 0f);
            this.leftArm.localEulerAngles = new Vector3(-105f, 25f, 42f);
            this.rightArmJoint.localEulerAngles = new Vector3(32f, -5f, 0f);
            this.leftArmJoint.localEulerAngles = new Vector3(-55f, 84f, -56f);*/

            this.rightLeg.localEulerAngles = new Vector3(15f, 0f, 15f);
            this.leftLeg.localEulerAngles = new Vector3(-12f, 0f, 20f);
            this.rightLegJoint.localEulerAngles = new Vector3(-3f, 0f, -30f);
            this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -19f);
        }
        ...
        {
            this.upperBody.localEulerAngles = new Vector3(0f, 0f, 0f);
            this.lowerBody.localEulerAngles = new Vector3(2f, 0f, 0f);
            //this.lowerBody.localEulerAngles = new Vector3(2f, 0f, 5f);
        }
        ...
        {
            this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.03f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * -2f, this.transform.forward.z * 55f, 0f);
            //this.body.localEulerAngles = new Vector3(this.transform.forward.z * -2f, this.transform.forward.z * 55f, -5f);
        }

        this.SetEyes(0);
    }

    public void MasterFlameGrabDash()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(0f, 16f, 100f);
            this.leftArm.localEulerAngles = new Vector3(-35f, 0f, -53f);
            this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 5f);
            this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 98f);
        ...
        {
            this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * -16f, -15f);
        }

        this.SetEyes(0);
    }

    public void DemonRageKickStartStart(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(30f, 0f, 0f);
            ...
            if (stageId == 0)
            {
                this.leftArm.localEulerAngles = new Vector3(-35f, 0f, 20f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 100f);
            }
            else if (stageId == 1)
            {
            ...
            this.rightLeg.localEulerAngles = new Vector3(0f, 0f, -17.5f);
            this.leftLeg.localEulerAngles = new Vector3(0f, 0f, -7.5f);
            this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -10f);
            this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
        ...
        if (this.eyes != null)
        {
            ...
            if (stageId == 0)
            {
                //this.eyes.localEulerAngles = new Vector3(0f, -9f, 0f);
                this.eyes.localEulerAngles = new Vector3(0f, 5f, 0f);
            }
            else if (stageId == 1)
            {
                //this.eyes.localEulerAngles = new Vector3(0f, -8.5f, 0f);
                this.eyes.localEulerAngles = new Vector3(0f, 4.5f, 0f);
            }
            else
            {
                this.eyes.localEulerAngles = new Vector3(0f, 0f, 0f);
        ...
        if (this.body != null)
        {
            this.body.localPosition = new Vector3(0.03f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 10f, 7.5f);
    ...
    public void DemonRageKickStart(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(50f, 0f, 0f);
                this.leftArm.localEulerAngles = new Vector3(-50f, 0f, 0f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 120f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 120f);
            }
            else if (stageId == 1)
            {
                this.rightArm.localEulerAngles = new Vector3(51f, 0f, 0f);
                this.leftArm.localEulerAngles = new Vector3(-51f, 0f, 0f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 118f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 118f);
            }
            else
            {
        ...
        if (this.body != null)
        {
            ...
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 9.5f, 10f);
            }
            else
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
    ...
    public void DemonRageKickLaunch(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(55f, 0f, -35f);
                this.leftArm.localEulerAngles = new Vector3(-66f, 0f, -20f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 100f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 90f);
                ...
                this.leftLeg.localEulerAngles = new Vector3(0f, 0f, 35f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -57.5f);
            }
            else if (stageId == 1)
            {
                this.rightArm.localEulerAngles = new Vector3(37f, 0f, -55f);
                this.leftArm.localEulerAngles = new Vector3(-117f, 0f, 40f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 35f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 0f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 0f, 60f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 0f, -18.5f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -110f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -15f);
            }
            else if (stageId == 2)
            {
                this.rightArm.localEulerAngles = new Vector3(45f, 0f, -30f);
                this.leftArm.localEulerAngles = new Vector3(-39f, 0f, 34f);
                this.rightArmJoint.localEulerAngles = new Vector3(0, 0, 113f);
                this.leftArmJoint.localEulerAngles = new Vector3(72f, 0f, 0f);
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(45f, 0f, -20f);
                this.leftArm.localEulerAngles = new Vector3(-39f, 0f, 34f);
                this.rightArmJoint.localEulerAngles = new Vector3(0, 0, 85f);
                this.leftArmJoint.localEulerAngles = new Vector3(44f, 0f, 0f);
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(78f, 0f, -25f);
                this.leftArm.localEulerAngles = new Vector3(-55f, 0f, 11f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 80f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 107f);
        ...
        if (this.upperBody != null && this.lowerBody != null)
        {
            ...
            {
                this.upperBody.localEulerAngles = new Vector3(0f, 16f, 0f);
                this.lowerBody.localEulerAngles = new Vector3(0f, 0f, 0f);
            }
            else
            {
        ...
        if (this.body != null)
        {
            ...
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, -10f);
            }
            else if (stageId == 1)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, -21f);
            }
            else if (stageId == 2)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * -0.1f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 20f, -32.5f);
            }
            else if (stageId == 3)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * -0.1f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 20f, -25f);
            }
            else if (stageId == 4)
            {
                this.body.localPosition = new Vector3(0.2f, this.defaultYPos - 0f, this.transform.forward.z * -0.1f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 20f, -15f);
            }
            else
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
    ...
    public void DemonRageKickMissKick(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(0f, 10f, 40f);
                this.leftArm.localEulerAngles = new Vector3(-20f, 0f, -42f);
                this.rightArmJoint.localEulerAngles = new Vector3(-96f, 0f, 40f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 92f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 0f, 1.5f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 0f, 10f);
                this.rightLegJoint.localEulerAngles = new Vector3(-38f, 0f, -45f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -5f);
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 0f, -13.5f);
                this.leftArm.localEulerAngles = new Vector3(-20f, 0f, -42f);
                this.rightArmJoint.localEulerAngles = new Vector3(-96f, 0f, 78f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 92f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 0f, 34.5f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 0f, 5f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -79f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -10f);
        ...
        if (this.body != null)
        {
            if (stageId == 0)
            {
                this.body.localPosition = new Vector3(0.02f, this.defaultYPos - 0.05f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, -15f);
            }
            else if (stageId == 1)
            {
                this.body.localPosition = new Vector3(0.02f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, -5f);
            }
            else if (stageId == 2)
            {
                this.body.localPosition = new Vector3(-0.19f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, 5f);
            }
            else if (stageId == 3)
            {
    ...
    public void JoekukyakuKicks(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 0f, -65f);
                this.leftArm.localEulerAngles = new Vector3(-20f, 0f, 70f);
                this.rightArmJoint.localEulerAngles = new Vector3(-35f, 0f, 0f);
                this.leftArmJoint.localEulerAngles = new Vector3(57.5f, 0f, 0f);

                //this.rightLeg.localEulerAngles = new Vector3(0f, 45f, 80f);
                this.rightLeg.localEulerAngles = new Vector3(0f, 35f, 80f);
                this.leftLeg.localEulerAngles = new Vector3(-45f, 0f, 0f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -110f);
                this.leftLegJoint.localEulerAngles = new Vector3(100f, 0f, 0f);
            }
            else if (stageId == 1)
            {
                this.rightArm.localEulerAngles = new Vector3(30f, 0f, -20f);
                this.leftArm.localEulerAngles = new Vector3(-40f, 0f, 63f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 130f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 35f, 80f);

                this.rightLeg.localEulerAngles = new Vector3(-20f, 0f, 45f);
                this.leftLeg.localEulerAngles = new Vector3(0f, -60f, 50f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 35f, -95f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 5f);
            }
        ...
        if (this.body != null)
        {
            if (stageId == 0)
            {
                this.body.localPosition = new Vector3(-0.3f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 17f, this.transform.forward.z * -33f, 24.5f);
            }
            else if (stageId == 1)
            {
                this.body.localPosition = new Vector3(-0.3f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * -20f, this.transform.forward.z * 60f, 10f);
            }
            else if (stageId == 2)
            {
                this.body.localPosition = new Vector3(-0.3f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
    ...
    public void JoekukyakuKicksInbetweens(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 0f, 42f);
                this.leftArm.localEulerAngles = new Vector3(-20f, 0f, -56f);
                this.rightArmJoint.localEulerAngles = new Vector3(-43f, 0f, 35f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 58f);
            ...
            else if (stageId == 1)
            {
                ...
                this.leftArm.localEulerAngles = new Vector3(-40f, 0f, -20f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, -15f, 85f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 85f);

                this.rightLeg.localEulerAngles = new Vector3(-25.5f, 0f, 80f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 0f, 90f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -100f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, -13.5f, -110f);
            }
            else
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 0f, 0f);
        ...
        if (this.body != null)
        {
            ...
            {
                this.body.localPosition = new Vector3(-0.3f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 10f, this.transform.forward.z * 0f, 24.5f);
            }
            else if (stageId == 1)
            {
                this.body.localPosition = new Vector3(-0.1f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 50f, -10f);
            }
            else
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
    ...
    public void SuperExplosiveGrab()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(0f, 13f, 78f);
            this.leftArm.localEulerAngles = new Vector3(0f, 0f, 61f);
            this.rightArmJoint.localEulerAngles = new Vector3(-73f, 0f, 20f);
            this.leftArmJoint.localEulerAngles = new Vector3(52f, 0f, 0f);
        ...
        {
            this.upperBody.localEulerAngles = new Vector3(0f, 0f, 0f);
            this.lowerBody.localEulerAngles = new Vector3(0f, 29f, 0f);
        }
        ...
        {
            this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, -17f);
        }

        this.SetEyes(0);
    }

    public void SuperExplosiveGrabStartPose()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(45f, 0f, 0f);
            this.leftArm.localEulerAngles = new Vector3(-45f, 0f, 0f);
            this.rightArmJoint.localEulerAngles = new Vector3(-90f, 0f, 0f);
            this.leftArmJoint.localEulerAngles = new Vector3(90f, 0f, 0f);

            this.rightLeg.localEulerAngles = new Vector3(15f, 0f, 0f);
            this.leftLeg.localEulerAngles = new Vector3(-15f, 0f, 0f);
            this.rightLegJoint.localEulerAngles = new Vector3(-15f, 0f, 0f);
            this.leftLegJoint.localEulerAngles = new Vector3(15f, 0f, 0f);
        }
        ...
        if (this.body != null)
        {
            this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.02f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 90f, 0f);
        }
    ...
    public void JoeCounter(int stageId = 0, float camDistance = 0f)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(22f, 0f, -2f);
                this.leftArm.localEulerAngles = new Vector3(-15f, 0f, 16.5f);
                this.rightArmJoint.localEulerAngles = new Vector3(-2.5f, 0f, 17.5f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 18f);

                this.rightLeg.localEulerAngles = new Vector3(2f, 0f, 7.5f);
                this.leftLeg.localEulerAngles = new Vector3(-6f, 0f, 10f);
                this.rightLegJoint.localEulerAngles = new Vector3(-2f, 0f, -15f);
                this.leftLegJoint.localEulerAngles = new Vector3(5f, 0f, -12.5f);
            }
            else if (stageId == 1)
            {
                this.rightArm.localEulerAngles = new Vector3(25f, 0f, -5f);
                this.leftArm.localEulerAngles = new Vector3(-10f, 0f, 33f);
                this.rightArmJoint.localEulerAngles = new Vector3(-5f, 0f, 35f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 36f);

                this.rightLeg.localEulerAngles = new Vector3(2f, 0f, 10f);
                this.leftLeg.localEulerAngles = new Vector3(-12f, 0f, 15f);
                this.rightLegJoint.localEulerAngles = new Vector3(-2f, 0f, -20f);
                this.leftLegJoint.localEulerAngles = new Vector3(10f, 0f, -20f);
            }
            else if (stageId == 2)
            {
                this.rightArm.localEulerAngles = new Vector3(14f, 0f, 13f);
                this.leftArm.localEulerAngles = new Vector3(-76f, 12.5f, 42f);
                this.rightArmJoint.localEulerAngles = new Vector3(-50f, -5f, 55f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 78f, -82f);

                this.rightLeg.localEulerAngles = new Vector3(2f, 0f, 15f);
                this.leftLeg.localEulerAngles = new Vector3(-12f, 0f, 20f);
                this.rightLegJoint.localEulerAngles = new Vector3(-2f, 0f, -30f);
                this.leftLegJoint.localEulerAngles = new Vector3(10f, 0f, -25f);
            }
            else if (stageId == 3)
            {
                this.rightArm.localEulerAngles = new Vector3(14f, 0f, 45f);
                this.leftArm.localEulerAngles = new Vector3(-116.5f, 12.5f, 42f);
                this.rightArmJoint.localEulerAngles = new Vector3(-50f, -5f, 55f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 78f, -94f);
        ...
        if (this.upperBody != null && this.lowerBody != null)
        {
            ...
            {
                this.upperBody.localEulerAngles = new Vector3(0f, 0f, 0f);
                this.lowerBody.localEulerAngles = new Vector3(0f, 0f, 1.25f);
            }
            else if (stageId == 1)
            {
                this.upperBody.localEulerAngles = new Vector3(0f, 0f, 0f);
        ...
        if (this.eyes != null)
        {
            ...
            {
                this.eyes.localPosition = new Vector3(0f, this.defaultEyeYHeight, 0f);
                this.eyes.localEulerAngles = new Vector3(0f, -7.5f, 0f);
            }
            else if (stageId == 1)
            {
                this.eyes.localPosition = new Vector3(0f, this.defaultEyeYHeight, 0f);
        ...
        if (this.body != null)
        {
            ...
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.03f, this.transform.forward.z * 0f);
                //this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 42.5f, -1.25f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 42.5f + (camDistance * 5), -1.25f);
            }
            else if (stageId == 1)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.03f, this.transform.forward.z * 0f);
                //this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 50f, -2.5f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 50f + (camDistance * 5), -2.5f);
            }
            else if (stageId == 2)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.03f, this.transform.forward.z * 0f);
                //this.body.localEulerAngles = new Vector3(this.transform.forward.z * -2f, this.transform.forward.z * 65f, -5f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * -2f, this.transform.forward.z * 65f + (camDistance * 5), -5f);
            }
            else if (stageId == 3)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.03f, this.transform.forward.z * 0f);
    ...
    public void JoeStartAnimationFalling(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(145f, 0f, -45f);
                this.leftArm.localEulerAngles = new Vector3(-145f, 0f, -45f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 0f);

                this.rightLeg.localEulerAngles = new Vector3(25f, 0f, -45f);
                this.leftLeg.localEulerAngles = new Vector3(-25f, 0f, -45f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
            }
            else if (stageId == 1)
            {
                this.rightArm.localEulerAngles = new Vector3(145f, 0f, 20f);
                this.leftArm.localEulerAngles = new Vector3(-145f, 0f, 20f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, -20f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, -20f);
            ...
            else
            {
                ...
                this.rightLeg.localEulerAngles = new Vector3(25f, 0f, 0f);
                this.leftLeg.localEulerAngles = new Vector3(-25f, 0f, 0f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -27f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -27f);
            }
        ...
        if (this.body != null)
        {
            if (stageId == 0)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 1.65f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, -80f);
            }
            else if (stageId == 1)
            {
            ...
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 1.25f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, -60f);
            }
    ...
    //[ContextMenu("JoeTauntAngry")]
    public void JoeTauntAngry(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            //this.rightArm.localEulerAngles = new Vector3(0f, 50f, 80f);
            this.rightArm.localEulerAngles = new Vector3(0f, 35f, 80f);
            //this.leftArm.localEulerAngles = new Vector3(0f, 10f, -57f);
            this.leftArm.localEulerAngles = new Vector3(0f, 22f, -50f);
            this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 100f);
            //this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 30f);
            this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 80f);

            /*this.rightLeg.localEulerAngles = new Vector3(0f, 0f, 35f);
            this.leftLeg.localEulerAngles = new Vector3(0f, 0f, -18f);
            this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -35f);
            this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -19f);*/

            this.rightLeg.localEulerAngles = new Vector3(0f, 0f, -18f);
            this.leftLeg.localEulerAngles = new Vector3(0f, 0f, 35f);
            this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -19f);
            this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -35f);
            ...
            else
            {
                ...
                //this.rightArm.localEulerAngles = new Vector3(0f, 50f, 82f);
                this.rightArm.localEulerAngles = new Vector3(0f, 35f, 82f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 98f);
            }
        }
        ...
        {
            this.upperBody.localEulerAngles = new Vector3(0f, -20f, 0f);
            this.lowerBody.localEulerAngles = new Vector3(0f, 35f, 0f);
        }
        ...
        if (this.body != null)
        {
            ...
            //this.body.localEulerAngles = new Vector3(0f, this.transform.forward.z * 180f, 0f);
            this.body.localEulerAngles = new Vector3(0f, this.transform.forward.z * -30, 0f);
            this.body.localPosition = new Vector3(this.transform.forward.z * -0.33f, this.defaultYPos - 0.12f, 0f);
        }
    ...
    public void JoeButtSlapTaunt(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(19f, 0f, 15f);
                this.leftArm.localEulerAngles = new Vector3(-25f, 0f, -25f);
                this.rightArmJoint.localEulerAngles = new Vector3(40f, 0f, 0f);
                this.leftArmJoint.localEulerAngles = new Vector3(50f, 0f, 25f);
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(18f, 0f, 15f);
                this.leftArm.localEulerAngles = new Vector3(-52f, 0f, -25f);
                this.rightArmJoint.localEulerAngles = new Vector3(38f, 0f, 0f);
                this.leftArmJoint.localEulerAngles = new Vector3(40f, 0f, 25f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 0f, 44f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 0f, 44f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -15f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -15f);
            }
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(18.5f, 0f, 15f);
                this.leftArm.localEulerAngles = new Vector3(-40f, 0f, -25f);
                this.rightArmJoint.localEulerAngles = new Vector3(39f, 0f, 0f);
                this.leftArmJoint.localEulerAngles = new Vector3(50f, 0f, 25f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 0f, 44.5f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 0f, 44.5f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -15f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, -15f);
            }
            else
        ...
        if (this.eyes != null)
        {
            ...
            this.eyes.localPosition = new Vector3(0f, this.defaultEyeYHeight, 0f);
            this.eyes.localEulerAngles = new Vector3(0f, -34f, 0f);
        ...
        if (this.body != null)
        {
            if (stageId == 0)
            {
                this.body.localPosition = new Vector3(-0.22f, this.defaultYPos - 0.12f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 180f, -30f);
            }
            else if (stageId == 1)
            {
                this.body.localPosition = new Vector3(-0.21f, this.defaultYPos - 0.11f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 180f, -29f);
            }
            else if (stageId == 2)
            {
                this.body.localPosition = new Vector3(-0.215f, this.defaultYPos - 0.115f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 180f, -29.5f);
            }
            else
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
    ...
    //[ContextMenu("WritingAutograph")]
    public void WritingAutograph(int armId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(0f, 20.4f, 65.8f);
            this.leftArm.localEulerAngles = new Vector3(0f, -13.65f, 57.7f);
            this.rightArmJoint.localEulerAngles = new Vector3(-68.16f, 0f, 20f);
            this.leftArmJoint.localEulerAngles = new Vector3(53.8f, 0f, 0f);

            this.rightLeg.localEulerAngles = new Vector3(2f, 0f, -5f);
            this.leftLeg.localEulerAngles = new Vector3(-2f, 0f, 0f);
            this.rightLegJoint.localEulerAngles = new Vector3(-2f, 0f, 0f);
            this.leftLegJoint.localEulerAngles = new Vector3(2f, 0f, 0f);

            if (armId == 1)
                this.rightArm.localEulerAngles = new Vector3(0f, 7f, 65.8f);
        ...
        {
            this.upperBody.localEulerAngles = new Vector3(0f, 0f, 0f);
            this.lowerBody.localEulerAngles = new Vector3(0f, 0f, -2f);
        }
        ...
        {
            this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 36.1f, 2f);
        }

        this.SetEyes(0);
    }

    public void ThrowAutoGraph(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 4.542835E-07f, 39.92f);
                this.leftArm.localEulerAngles = new Vector3(1.707547E-06f, 302f, 81.99999f);
                this.rightArmJoint.localEulerAngles = new Vector3(8.537737E-07f, 330.46f, 81.84f);
                this.leftArmJoint.localEulerAngles = new Vector3(68.00001f, -4.558241E-06f, 37f);

                this.rightLeg.localEulerAngles = new Vector3(5.000002f, 0f, 0f);
                this.leftLeg.localEulerAngles = new Vector3(355f, 0f, 0f);
                this.rightLegJoint.localEulerAngles = new Vector3(355f, 0f, 0f);
                this.leftLegJoint.localEulerAngles = new Vector3(5.000002f, 0f, 0f);
            }
            else if (stageId == 1)
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 4.542835E-07f, 39.92f);
                this.leftArm.localEulerAngles = new Vector3(0f, 260.6f, 90f);
                this.rightArmJoint.localEulerAngles = new Vector3(8.537737E-07f, 330.46f, 81.84f);
                this.leftArmJoint.localEulerAngles = new Vector3(75.80001f, 0f, 34.29998f);
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(0f, 25.79999f, 58.39999f);
                this.leftArm.localEulerAngles = new Vector3(21.72001f, 298.3f, 30.68f);
                this.rightArmJoint.localEulerAngles = new Vector3(304.7f, 268.1f, 79.30002f);
                this.leftArmJoint.localEulerAngles = new Vector3(77.39003f, 0f, 9.099994f);
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(0f, 48.5f, 89.2f);
                this.leftArm.localEulerAngles = new Vector3(-1.707547E-06f, 260.6f, 34.99999f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 78.67f);
                this.leftArmJoint.localEulerAngles = new Vector3(70.60003f, 180f, 214.3f);
        ...
        if (this.upperBody != null && this.lowerBody != null)
        {
            ...
            {
                this.upperBody.localEulerAngles = new Vector3(0f, 0f, 0f);
                this.lowerBody.localEulerAngles = new Vector3(0f, 0f, 2.999997f);
            }
            else if (stageId == 3)
            {
                this.upperBody.localEulerAngles = new Vector3(0f, 0f, 0f);
                this.lowerBody.localEulerAngles = new Vector3(0f, 0f, 358f);
            }
            else
            {
                this.upperBody.localEulerAngles = new Vector3(0f, 0f, 0f);
        ...
        if (this.eyes != null)
        {
            if (stageId == 0)
            {
                this.eyes.localEulerAngles = new Vector3(0f, 329.2f, 0f);
            }
            else if (stageId == 1)
            {
                this.eyes.localEulerAngles = new Vector3(0f, 329.2f, 0f);
        ...
        if (this.body != null)
        {
            ...
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 90f, 357f);
            }
            else if (stageId == 3)
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
                this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 90f, 2.000005f);
            }
            else
            {
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 0f, this.transform.forward.z * 0f);
    ...
    public void JoeButtSlam(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 0f, 310f);
                this.leftArm.localEulerAngles = new Vector3(340f, 0f, 310f);
                this.rightArmJoint.localEulerAngles = new Vector3(350f, 0f, 55f);
                this.leftArmJoint.localEulerAngles = new Vector3(10f, 0f, 55f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 5f, 120f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 355f, 120f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, 300f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 310f);
            }
            else if (stageId == 1)
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 0f, 350f);
                this.leftArm.localEulerAngles = new Vector3(340f, 0f, 350f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 20f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 20f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 5f, 90f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 355f, 90f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, 335f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 335f);
            }
            else
            {
                this.rightArm.localEulerAngles = new Vector3(20f, 0f, 0f);
        ...
        if (this.body != null)
        {
            /*this.body.localPosition = new Vector3(0f, this.defaultYPos - 0.38f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, 0f);*/
    ...
    public void JoeButtSlamLaying(int stageId = 0)
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            if (stageId == 0)
            {
                this.rightArm.localEulerAngles = new Vector3(0, 115f, 40f);
                this.leftArm.localEulerAngles = new Vector3(0, 245f, 40f);
                this.rightArmJoint.localEulerAngles = new Vector3(345f, 0f, 0f);
                this.leftArmJoint.localEulerAngles = new Vector3(15f, 0f, 0f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 320f, 345f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 40f, 345f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, 4f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 4f);

            }
            else if (stageId == 1)
            {
                this.rightArm.localEulerAngles = new Vector3(0f, 20f, 90f);
                this.leftArm.localEulerAngles = new Vector3(0f, 340f, 90f);
                this.rightArmJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
                this.leftArmJoint.localEulerAngles = new Vector3(0f, 0f, 0f);

                this.rightLeg.localEulerAngles = new Vector3(0f, 20f, 60f);
                this.leftLeg.localEulerAngles = new Vector3(0f, 340f, 60f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 0f);

                if (this.characterId == 3 || this.characterId == 4 || this.characterId == 7)
                {
                    this.rightLeg.localEulerAngles = new Vector3(0f, 30f, 60f);
                    this.leftLeg.localEulerAngles = new Vector3(0f, 340f, 60f);
                }
            ...
            {
                this.rightArm.localEulerAngles = new Vector3(0f, 110f, 90f);
                this.leftArm.localEulerAngles = new Vector3(0f, 250f, 90f);
                this.rightArmJoint.localEulerAngles = new Vector3(345f, 0f, 0f);
                this.leftArmJoint.localEulerAngles = new Vector3(15f, 0f, 0f);

                this.rightLeg.localEulerAngles = new Vector3(35f, 0f, 345f);
                this.leftLeg.localEulerAngles = new Vector3(325f, 0f, 345f);
                this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, 6f);
                this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 6f);

                if (this.characterId == 3 || this.characterId == 4 || this.characterId == 7)
                {
                    this.rightArm.localEulerAngles = new Vector3(0f, 105f, 90f);
                    this.leftArm.localEulerAngles = new Vector3(0f, 255f, 90f);
                    this.rightArmJoint.localEulerAngles = new Vector3(350f, 0f, 0f);
                    this.leftArmJoint.localEulerAngles = new Vector3(10f, 0f, 0f);

                    this.rightLeg.localEulerAngles = new Vector3(35f, 0, 350f);
                    this.leftLeg.localEulerAngles = new Vector3(325f, 0, 350f);
                }
        ...
        if (this.body != null)
        {
            ...
            if (this.characterId == 3 || this.characterId == 4 || this.characterId == 7)
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 1.4f, this.transform.forward.z * 0f);


            /*this.body.localPosition = new Vector3(0f, this.defaultYPos - 1.7f, this.transform.forward.z * 0f);
            this.body.localEulerAngles = new Vector3(this.transform.forward.z * 0f, this.transform.forward.z * 0f, 90f);

            if (this.characterId == 3 || this.characterId == 4 || this.characterId == 7)
                this.body.localPosition = new Vector3(0f, this.defaultYPos - 1.45f, this.transform.forward.z * 0f);*/
    ...
    public void JoeTackle()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(60f, 20f, 0f);
            this.leftArm.localEulerAngles = new Vector3(305f, 0f, 0f);
            this.rightArmJoint.localEulerAngles = new Vector3(315f, 0f, 0f);
            this.leftArmJoint.localEulerAngles = new Vector3(105f, 0f, 0f);

            this.rightLeg.localEulerAngles = new Vector3(0f, 0f, 35f);
            this.leftLeg.localEulerAngles = new Vector3(0f, 0f, 315f);
            this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, 290f);
            this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 350f);
        }

        if (this.upperBody != null && this.lowerBody != null)
        {
            this.upperBody.localEulerAngles = new Vector3(0f, 90f, 0f);
            this.lowerBody.localEulerAngles = new Vector3(0f, 0f, 0f);
        }
        ...
        if (this.belt != null)
            this.belt.localEulerAngles = new Vector3(0f, -25f, 0f);

        this.SetEyes(0);
    }

    public void JoeTackleMiss()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(36f, 20f, 0f);
            this.leftArm.localEulerAngles = new Vector3(324f, 0f, 0f);
            this.rightArmJoint.localEulerAngles = new Vector3(315f, 0f, 0f);
            this.leftArmJoint.localEulerAngles = new Vector3(16f, 0f, 0f);
    ...
    //[ContextMenu("IceCubeFreezePose")]
    public void IceCubeFreezePose()
    {
        if (this.rightArm != null && this.rightArmJoint != null && this.leftArm != null && this.leftArmJoint != null && this.rightLeg != null && this.rightLegJoint != null && this.leftLeg != null && this.leftLegJoint != null)
        {
            this.rightArm.localEulerAngles = new Vector3(35f, 0f, 25f);
            this.leftArm.localEulerAngles = new Vector3(-35f, 0f, 35f);
            this.rightArmJoint.localEulerAngles = new Vector3(0f, 40f, 120f);
            this.leftArmJoint.localEulerAngles = new Vector3(0f, -40f, 120f);

            this.rightLeg.localEulerAngles = new Vector3(20f, 0f, -5f);
            this.leftLeg.localEulerAngles = new Vector3(-4f, 0f, 0f);
            this.rightLegJoint.localEulerAngles = new Vector3(0f, 0f, -25f);
            this.leftLegJoint.localEulerAngles = new Vector3(0f, 0f, 0f);
        }
