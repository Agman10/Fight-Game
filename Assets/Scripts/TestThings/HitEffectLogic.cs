...
public class HitEffectLogic : MonoBehaviour
{
    ...
    public void DoHitEffect(float yPos, float forwardZ)
    {
        ...
        if (this.hitEffect != null)
        {
            ...
            hitEffectPrefab = Instantiate(hitEffectPrefab, new Vector3(this.transform.position.x + (forwardZ * 0.6f), yPos, 0f), Quaternion.Euler(0, 0, 0));
        }
    }
